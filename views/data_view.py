...
class DataView(QWidget):
    ...
    def init_ui(self):
        ...
        self.search_input.returnPressed.connect(self.search_user)  # 回车键搜索
        ...
        self.status_filter.addItems(['全部', '✅ 已采集', '⏳ 待采集', '❌ 失败', '⚠️ 无记录'])
        ...
        self.table.setHorizontalHeaderLabels([
            'ID', '姓名', '身份证号', '性别', '民族', '出生日期', '采集状态', '原始照片', '处理照片', '操作'
        ])
